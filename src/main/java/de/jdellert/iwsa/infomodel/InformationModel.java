...
public class InformationModel {
    ...
    public double informationContent(int a, int b, int c, int d, int e) {
        ...
        if (VERBOSE)
            System.out.print("(" + Math.round(abcCount) + "+" + Math.round(bcdCount) + "+" + Math.round(cdeCount) + ")/");
        if (VERBOSE)
            System.out.println("(" + Math.round(abCount) + "+" + Math.round(bdCount) + "+" + Math.round(deCount) + ")");
