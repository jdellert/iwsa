...
public class PhoneticStringAlignmentOutput {
	public static String needlemanWunschtoString(PhoneticStringAlignment alignment, PhoneticSymbolTable table,
		...
		return selfSim1Line.toString() + string1Line.toString() + corrLine.toString() + string2Line.toString() + selfSim2Line.toString();
	}
	...
	public static String iwsaToString(PhoneticStringAlignment alignment, PhoneticSymbolTable table,
		...
		for (int pos = 0; pos < alignment.getLength(); pos++)
		{
			...
			if (symb1 > 1) infoScore1 = InformationWeightedSequenceAlignment.getInfoScore(str1Reduced, pos1, infoModel1);
			...
			if (symb1 == 1)
			{
				corrScoreSum += corrScore * InformationWeightedSequenceAlignment.getMeanInfoScore(str2Reduced, str2Reduced, pos2, pos2, infoModel2, infoModel2);
			...
			{
				corrScoreSum += corrScore * InformationWeightedSequenceAlignment.getMeanInfoScore(str1Reduced, str1Reduced, pos1, pos1, infoModel1, infoModel1);
